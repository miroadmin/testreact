  ...
  return (
    <>
      <BrowserRouter>
          <Header/>
          <Routes>
              <Route path="/list" exact element={<Players players={players}/>} />
              <Route path="/" exact element={<PlayersTable players={players}/>} />
    ...
    <div>
      <header className="header"> 
          ...
          <span className="titleButton"> 
            <Link to="/" ><MdPlaylistAdd /> ver Table  </Link>      
            <Link to="/list" style={{marginLeft:"50px"}}> <MdViewList /> ver List </Link>
          </span>
      </header>
      <hr />
